...
import UniswapV2Factory from '@atleta-chain/v2-core/build/UniswapV2Factory.json'
import IUniswapV2Pair from '@atleta-chain/v2-core/build/IUniswapV2Pair.json'
